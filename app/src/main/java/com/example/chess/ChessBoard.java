...
public class ChessBoard extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        whitePlayer = bundle.getString("whitePlayer");
        blackPlayer = bundle.getString("blackPlayer");
        initializeBoard();
    ...
    public void onSurrenderWhite(View v){
        ...
        boolean isInserted = databaseHelper.insertData(whitePlayer + " vs " + blackPlayer, blackPlayer, Calendar.getInstance().getTime().toString());
        if(isInserted){
            Toast.makeText(ChessBoard.this, "Data Succesfully Inserted", Toast.LENGTH_SHORT).show();
        }
        else{
            Toast.makeText(ChessBoard.this, "Unsuccessful ", Toast.LENGTH_SHORT).show();

        }
        intent.putExtra("Winner", blackPlayer);
        startActivity(intent);
    }

    public void onSurrenderBlack(View v){
        Intent intent = new Intent(ChessBoard.this, ResultSplash.class);
        boolean isInserted = databaseHelper.insertData(whitePlayer + " vs " + blackPlayer, whitePlayer, Calendar.getInstance().getTime().toString());
        if(isInserted){
            Toast.makeText(ChessBoard.this, "Data Succesfully Inserted", Toast.LENGTH_SHORT).show();
        }
        else{
        ...
        intent.putExtra("Winner", whitePlayer);
        startActivity(intent);
    }

    public void onDraw(View v){
        Intent intent = new Intent(ChessBoard.this, ResultSplash.class);
        boolean isInserted = databaseHelper.insertData(whitePlayer + " vs " + blackPlayer, "DRAW", Calendar.getInstance().getTime().toString());
        if(isInserted){
            Toast.makeText(ChessBoard.this, "Data Succesfully Inserted", Toast.LENGTH_SHORT).show();
        }
        else{
            ...
            if(Board[clickedPosition.getX()][clickedPosition.getY()].getPiece() == null){
                if(moveIsAllowed(listOfCoordinates , clickedPosition)){
                    ...
                    if(Board[clickedPosition.getX()][clickedPosition.getY()].getPiece() instanceof King){
                        if(Board[clickedPosition.getX()][clickedPosition.getY()].getPiece().isWhite() != FirstPlayerTurn){
                            game_over.setText(whitePlayer + " WINS");
                    ...
                    if(Board[clickedPosition.getX()][clickedPosition.getY()].getPiece() !=null){
                        if(Board[clickedPosition.getX()][clickedPosition.getY()].getPiece().isWhite() != FirstPlayerTurn){
                            if(moveIsAllowed(listOfCoordinates , clickedPosition)){
                                ...
                                if(Board[clickedPosition.getX()][clickedPosition.getY()].getPiece() instanceof King){
                                    if(Board[clickedPosition.getX()][clickedPosition.getY()].getPiece().isWhite() != FirstPlayerTurn){
                                        game_over.setText(blackPlayer + " WINS");
                                        game_over.setVisibility(View.VISIBLE);
                                        Intent intent = new Intent(ChessBoard.this, ResultSplash.class);
                                        boolean isInserted = databaseHelper.insertData(whitePlayer + " vs " + blackPlayer, blackPlayer, Calendar.getInstance().getTime().toString());
                                        if(isInserted){
